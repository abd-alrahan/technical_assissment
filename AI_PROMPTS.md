...
**Prompt:**
> "Set up a React + TypeScript project with Vite, Tailwind CSS, and shadcn/ui. Create a professional folder structure with clear separation of concerns: components, pages, services, types, contexts, and routes. Include proper TypeScript configuration and ESLint setup."
